...
struct JHybridNitroNetworkInfoSpecImpl: public jni::JavaClass<JHybridNitroNetworkInfoSpecImpl, JHybridNitroNetworkInfoSpec::JavaPart> {
  ...
  static std::shared_ptr<JHybridNitroNetworkInfoSpec> create() {
    ...
    jni::local_ref<JHybridNitroNetworkInfoSpec::JavaPart> javaPart = javaClassStatic()->newObject(constructorFn);
