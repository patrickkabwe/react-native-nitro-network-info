...
namespace margelo::nitro::nitronetworkinfo {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitronetworkinfo/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitronetworkinfo/Func_void_cxx;";
