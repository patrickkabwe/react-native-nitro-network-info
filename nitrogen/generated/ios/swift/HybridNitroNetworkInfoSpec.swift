...
public extension HybridNitroNetworkInfoSpec_protocol {
...
open class HybridNitroNetworkInfoSpec_base {
  ...
  public func getCxxWrapper() -> HybridNitroNetworkInfoSpec_cxx {
  #if DEBUG
    guard self is any HybridNitroNetworkInfoSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridNitroNetworkInfoSpec_cxx(self as! any HybridNitroNetworkInfoSpec)
